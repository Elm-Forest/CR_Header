...
from uent_model import AttnCGAN_CR, AttnCGAN_CR0
...
parser.add_argument('--weights_path', type=str, default='checkpoint/checkpoint_9504_big.pth')
...
if opts.use_sar and opts.use_input2 is False:
    ...
    meta_learner = AttnCGAN_CR0(2, 13, 3, 3, bilinear=True).to(device)
else:
